...
<head>
	...
	<title>THE SUPPPERB | Register as author</title>
</head>
<body>
	<div class="container">
		<form action="" method="POST" class="login-email">
            <p class="login-text" style="font-size: 2rem; font-weight: 800;">Register as author</p>
			...
			<p class="login-register-text">Already a author? <a href="authlogin.php">Go here</a>.</p>
            <p class="login-register-text">Register as reader <a href="register.php">here</a>.</p>
		</form>
	</div>
